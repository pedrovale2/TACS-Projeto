...
public class SectionImpl extends MinimalEObjectImpl.Container implements Section {
	...
	protected EClass eStaticClass() {
		return CurriculoPackage.Literals.SECTION;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this,
					CurriculoPackage.SECTION__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public boolean diffNameSection(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					CurriculoPackage.Literals.SECTION___DIFF_NAME_SECTION__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_curriculo_c_c_Section = idResolver
							.getClass(CurriculoTables.CLSSid_Section, null);
					final /*@NonInvalid*/ SetValue allInstances = ClassifierAllInstancesOperation.INSTANCE
							.evaluate(executor, CurriculoTables.SET_CLSSid_Section, TYP_curriculo_c_c_Section);
					/*@Thrown*/ Accumulator accumulator = ValueUtil
							.createSetAccumulatorValue(CurriculoTables.SET_CLSSid_Section);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case CurriculoPackage.SECTION___DIFF_NAME_SECTION__DIAGNOSTICCHAIN_MAP:
