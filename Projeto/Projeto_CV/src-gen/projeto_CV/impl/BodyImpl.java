 ...
 * </p>
 * <ul>
 *   <li>{@link projeto_CV.impl.BodyImpl#getRow <em>Row</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BodyImpl extends MinimalEObjectImpl.Container implements Body {
	...
	protected EClass eStaticClass() {
		return Projeto_CVPackage.Literals.BODY;
	}
	...
	public EList<Row> getRow() {
		if (row == null) {
			row = new EObjectContainmentEList<Row>(Row.class, this, Projeto_CVPackage.BODY__ROW);
		}
		return row;
	}
