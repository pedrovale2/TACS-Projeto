 ...
 * </p>
 * <ul>
 *   <li>{@link projeto_CV.impl.CVImpl#getSections <em>Sections</em>}</li>
 *   <li>{@link projeto_CV.impl.CVImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CVImpl extends MinimalEObjectImpl.Container implements CV {
	...
	public EList<Section> getSections() {
		if (sections == null) {
			sections = new EObjectContainmentEList<Section>(Section.class, this, Projeto_CVPackage.CV__SECTIONS);
		}
		return sections;
	}
	...
	public void setVersion(float newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Projeto_CVPackage.CV__VERSION, oldVersion, version));
	}
