...
/**
 * This is the item provider adapter for a {@link projeto_CV.Body} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BodyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addRowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Body_row_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Body_row_feature", "_UI_Body_type"),
						Projeto_CVPackage.Literals.BODY__ROW, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Projeto_CVPackage.Literals.BODY__ROW);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case Projeto_CVPackage.BODY__ROW:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(Projeto_CVPackage.Literals.BODY__ROW, Projeto_CVFactory.eINSTANCE.createRow()));
	}
